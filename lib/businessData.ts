// Shared business types and keyword suggestions used across the app
...
// Keywords that customers search for on Yelp/Google - format: "best {keyword} near me"
...
// Focused search keywords for the demo - shorter, high-intent keywords customers actually search
export const demoKeywordSuggestions: Record<string, string[]> = {
  // Food & Beverage
  'Restaurant': ['best restaurant', 'good food', 'dinner near me', 'lunch spot', 'family restaurant'],
  'Cafe': ['best coffee', 'coffee shop', 'cafe near me', 'breakfast spot', 'brunch cafe'],
  'Bar': ['best bar', 'cocktails near me', 'happy hour', 'sports bar', 'rooftop bar'],
  'Bakery': ['best bakery', 'fresh bread', 'custom cakes', 'pastries near me', 'cupcakes'],
  'Food Truck': ['food truck', 'best tacos', 'street food', 'quick lunch', 'food truck near me'],
  'Pizzeria': ['best pizza', 'pizza delivery', 'pizza near me', 'NY style pizza', 'late night pizza'],
  'Sushi Bar': ['best sushi', 'sushi near me', 'sashimi', 'omakase', 'japanese food'],
  'Ice Cream Shop': ['best ice cream', 'ice cream near me', 'gelato', 'frozen yogurt', 'milkshake'],
  'Brewery': ['craft beer', 'brewery near me', 'local brewery', 'beer garden', 'taproom'],
  'Winery': ['wine tasting', 'winery tour', 'best winery', 'local wine', 'vineyard'],
  'Juice Bar': ['juice bar', 'smoothie near me', 'acai bowl', 'cold pressed juice', 'healthy drinks'],
  'Deli': ['best deli', 'sandwich shop', 'sub near me', 'cold cuts', 'lunch deli'],
  'Steakhouse': ['best steak', 'steakhouse near me', 'prime rib', 'fine dining', 'date night'],
  'Seafood Restaurant': ['best seafood', 'fresh fish', 'oyster bar', 'seafood near me', 'crab legs'],
  'BBQ Restaurant': ['best bbq', 'smoked brisket', 'bbq near me', 'ribs', 'pulled pork'],
  'Mexican Restaurant': ['best mexican food', 'tacos near me', 'authentic mexican', 'margaritas', 'burritos'],
  'Italian Restaurant': ['best italian', 'pasta near me', 'italian restaurant', 'pizza', 'romantic dinner'],
  'Chinese Restaurant': ['best chinese food', 'chinese near me', 'dim sum', 'fried rice', 'takeout'],
  'Thai Restaurant': ['best thai food', 'thai near me', 'pad thai', 'curry', 'thai restaurant'],
  'Indian Restaurant': ['best indian food', 'indian near me', 'tikka masala', 'naan', 'curry'],
  'Vietnamese Restaurant': ['best pho', 'vietnamese near me', 'banh mi', 'pho restaurant', 'vietnamese food'],
  'Greek Restaurant': ['best greek food', 'gyro near me', 'greek restaurant', 'falafel', 'mediterranean'],
  'Mediterranean Restaurant': ['mediterranean food', 'hummus', 'falafel near me', 'kebab', 'healthy food'],
  'Brunch Spot': ['best brunch', 'brunch near me', 'bottomless mimosas', 'eggs benedict', 'weekend brunch'],
  'Donut Shop': ['best donuts', 'donut shop', 'fresh donuts', 'coffee and donuts', 'krispy kreme'],
  'Bagel Shop': ['best bagels', 'bagel shop', 'bagels near me', 'lox bagel', 'breakfast bagel'],
  'Smoothie Shop': ['best smoothie', 'smoothie near me', 'protein shake', 'healthy smoothie', 'acai'],
  'Tea House': ['tea house', 'best tea', 'afternoon tea', 'bubble tea', 'matcha'],
  'Bubble Tea': ['bubble tea', 'boba near me', 'best boba', 'milk tea', 'tapioca'],
  'Dessert Shop': ['best dessert', 'dessert near me', 'sweets', 'cake shop', 'late night dessert'],
  
  // Retail - Food & Beverage
  'Liquor Store': ['liquor store', 'wine shop', 'beer selection', 'spirits', 'alcohol delivery'],
  'Wine Shop': ['wine shop', 'best wine selection', 'wine near me', 'wine expert', 'fine wine'],
  'Grocery Store': ['grocery store', 'supermarket', 'organic grocery', 'fresh produce', 'grocery near me'],
  'Supermarket': ['supermarket', 'grocery store', 'best prices', 'weekly deals', 'one stop shop'],
  'Convenience Store': ['convenience store', '24 hour store', 'corner store', 'quick stop', 'snacks'],
  'Butcher Shop': ['butcher shop', 'fresh meat', 'prime cuts', 'local butcher', 'quality meat'],
  'Seafood Market': ['seafood market', 'fresh fish', 'fish market', 'shellfish', 'crab market'],
  'Specialty Food Store': ['specialty food', 'gourmet food', 'imported goods', 'artisan food', 'cheese shop'],
  'Health Food Store': ['health food', 'organic store', 'natural food', 'vitamins', 'supplements'],
  'Candy Store': ['candy store', 'candy shop', 'bulk candy', 'sweet shop', 'chocolate'],
  'Chocolate Shop': ['chocolate shop', 'best chocolate', 'artisan chocolate', 'truffles', 'gift chocolate'],
  
  // Smoke & Vape
  'Smoke Shop': ['smoke shop', 'tobacco store', 'cigars', 'pipes', 'smoking accessories'],
  'Vape Shop': ['vape shop', 'vape store', 'e-liquid', 'vape near me', 'best vape'],
  'CBD Store': ['cbd store', 'cbd shop', 'cbd oil', 'hemp products', 'cbd near me'],
  'Dispensary': ['dispensary', 'cannabis', 'marijuana dispensary', 'weed shop', 'best dispensary'],
  
  // Health & Beauty
  'Salon': ['hair salon', 'best haircut', 'salon near me', 'hair color', 'balayage'],
  'Barbershop': ['barbershop', 'best barber', 'haircut near me', 'fade', 'mens haircut'],
  'Spa': ['spa near me', 'best spa', 'massage', 'facial', 'day spa'],
  'Nail Salon': ['nail salon', 'manicure', 'pedicure', 'gel nails', 'nail art'],
  'Med Spa': ['med spa', 'botox', 'filler', 'laser treatment', 'anti-aging'],
  'Massage Therapy': ['massage near me', 'best massage', 'deep tissue', 'sports massage', 'relaxation'],
  'Tattoo Parlor': ['tattoo shop', 'best tattoo artist', 'tattoo near me', 'custom tattoo', 'piercing'],
  'Tanning Salon': ['tanning salon', 'spray tan', 'tanning near me', 'uv tanning', 'bronzing'],
  'Skincare Clinic': ['skincare clinic', 'facial near me', 'acne treatment', 'esthetician', 'skin treatment'],
  'Lash Studio': ['lash extensions', 'best lashes', 'lash studio', 'eyelash near me', 'lash lift'],
  'Brow Bar': ['brow bar', 'eyebrow threading', 'microblading', 'brow shaping', 'eyebrow near me'],
  'Waxing Studio': ['waxing near me', 'brazilian wax', 'waxing studio', 'best wax', 'hair removal'],
  'Hair Extensions': ['hair extensions', 'best extensions', 'tape in extensions', 'hair salon', 'volume'],
  'Wig Shop': ['wig shop', 'wigs near me', 'human hair wigs', 'lace front', 'custom wigs'],
  'Beauty Supply': ['beauty supply', 'hair products', 'beauty store', 'cosmetics', 'professional products'],
  
  // Automotive
  'Auto Shop': ['auto repair', 'mechanic near me', 'car repair', 'oil change', 'brake repair'],
  'Car Wash': ['car wash', 'car wash near me', 'auto detailing', 'hand wash', 'express wash'],
  'Auto Detailing': ['auto detailing', 'car detailing', 'detail near me', 'paint correction', 'ceramic coating'],
  'Tire Shop': ['tire shop', 'tires near me', 'tire repair', 'new tires', 'wheel alignment'],
  'Body Shop': ['body shop', 'collision repair', 'auto body', 'dent repair', 'paint job'],
  'Oil Change': ['oil change', 'quick lube', 'oil change near me', 'synthetic oil', 'jiffy lube'],
  'Car Dealership': ['car dealership', 'used cars', 'new cars', 'best deals', 'car dealer'],
  'Motorcycle Shop': ['motorcycle shop', 'harley dealer', 'bike shop', 'motorcycle repair', 'parts'],
  'Auto Parts Store': ['auto parts', 'car parts', 'auto zone', 'parts store', 'car accessories'],
  'Transmission Shop': ['transmission repair', 'transmission shop', 'transmission near me', 'auto repair'],
  'Muffler Shop': ['muffler shop', 'exhaust repair', 'muffler near me', 'catalytic converter', 'exhaust'],
  'Towing Service': ['towing', 'tow truck', 'roadside assistance', '24 hour towing', 'tow near me'],
  'Car Rental': ['car rental', 'rent a car', 'rental car', 'cheap car rental', 'car hire'],
  
  // Fitness & Recreation
  'Gym': ['gym near me', 'best gym', 'fitness center', '24 hour gym', 'weight training'],
  'Yoga Studio': ['yoga studio', 'yoga near me', 'hot yoga', 'yoga classes', 'best yoga'],
  'Pilates Studio': ['pilates studio', 'pilates near me', 'reformer pilates', 'best pilates', 'pilates classes'],
  'CrossFit': ['crossfit gym', 'crossfit near me', 'best crossfit', 'functional fitness', 'crossfit box'],
  'Martial Arts': ['martial arts', 'karate near me', 'mma gym', 'jiu jitsu', 'self defense'],
  'Dance Studio': ['dance studio', 'dance classes', 'ballroom dancing', 'hip hop dance', 'salsa lessons'],
  'Golf Course': ['golf course', 'golf near me', 'public golf', 'driving range', 'tee time'],
  'Bowling Alley': ['bowling alley', 'bowling near me', 'cosmic bowling', 'bowling lanes', 'family bowling'],
  'Rock Climbing Gym': ['rock climbing', 'climbing gym', 'bouldering', 'indoor climbing', 'climbing near me'],
  'Swimming Pool': ['swimming pool', 'pool near me', 'swim lessons', 'lap pool', 'public pool'],
  'Tennis Club': ['tennis club', 'tennis courts', 'tennis lessons', 'tennis near me', 'tennis coach'],
  'Boxing Gym': ['boxing gym', 'boxing near me', 'boxing classes', 'learn boxing', 'best boxing'],
  'Spin Studio': ['spin class', 'cycling studio', 'spin near me', 'indoor cycling', 'best spin'],
  ...
  'Pet Store': ['pet store', 'pet shop', 'pet supplies', 'dog food', 'pet near me'],
  'Bookstore': ['bookstore', 'book shop', 'local bookstore', 'used books', 'best books'],
  'Gift Shop': ['gift shop', 'gift store', 'unique gifts', 'local gifts', 'souvenirs'],
  'Furniture Store': ['furniture store', 'furniture near me', 'home furniture', 'best furniture', 'sofa store'],
  'Electronics Store': ['electronics store', 'best buy', 'tech store', 'computer store', 'tv store'],
  'Hardware Store': ['hardware store', 'home depot', 'tools', 'home improvement', 'lumber'],
  'Sporting Goods': ['sporting goods', 'sports store', 'dicks', 'athletic gear', 'sports equipment'],
  'Bicycle Shop': ['bike shop', 'bicycle store', 'bike repair', 'bikes near me', 'cycling shop'],
  'Outdoor Store': ['outdoor store', 'rei', 'camping gear', 'hiking gear', 'outdoor equipment'],
  'Thrift Store': ['thrift store', 'thrift shop', 'goodwill', 'secondhand', 'consignment'],
  'Consignment Shop': ['consignment shop', 'resale shop', 'designer consignment', 'upscale resale'],
  'Antique Store': ['antique store', 'antiques', 'vintage shop', 'antique mall', 'collectibles'],
  'Art Gallery': ['art gallery', 'local art', 'gallery near me', 'art for sale', 'contemporary art'],
  
  // Pet Services
  'Pet Groomer': ['pet grooming', 'dog grooming', 'groomer near me', 'cat grooming', 'best groomer'],
  'Dog Trainer': ['dog trainer', 'dog training', 'puppy training', 'obedience training', 'best trainer'],
  'Pet Boarding': ['pet boarding', 'dog boarding', 'kennel', 'pet hotel', 'dog daycare'],
  'Doggy Daycare': ['doggy daycare', 'dog daycare', 'puppy daycare', 'pet daycare', 'daycare near me'],
  'Pet Sitter': ['pet sitter', 'dog sitter', 'cat sitter', 'pet sitting', 'in home pet care'],
  
  // Services
  'Dry Cleaner': ['dry cleaner', 'dry cleaning', 'laundry service', 'alterations', 'cleaners near me'],
  'Laundromat': ['laundromat', 'laundry near me', 'coin laundry', 'wash and fold', '24 hour laundry'],
  'Tailor': ['tailor', 'alterations', 'tailor near me', 'suit alterations', 'seamstress'],
  'Locksmith': ['locksmith', 'locksmith near me', 'car lockout', 'lock repair', '24 hour locksmith'],
  'Moving Company': ['moving company', 'movers', 'moving near me', 'best movers', 'local movers'],
  'Storage Facility': ['storage unit', 'self storage', 'storage near me', 'mini storage', 'climate controlled'],
  'Printing Shop': ['print shop', 'printing near me', 'copies', 'business cards', 'custom printing'],
  'Shipping Store': ['ups store', 'fedex', 'shipping near me', 'pack and ship', 'mailbox'],
  
  // Professional Services
  'Law Firm': ['lawyer', 'attorney', 'law firm', 'legal help', 'lawyer near me'],
  'Accounting Firm': ['accountant', 'cpa', 'tax accountant', 'bookkeeper', 'accounting firm'],
  'Insurance Agency': ['insurance agent', 'insurance near me', 'auto insurance', 'home insurance', 'best rates'],
  'Real Estate Agency': ['realtor', 'real estate agent', 'homes for sale', 'best realtor', 'buy house'],
  'Marketing Agency': ['marketing agency', 'digital marketing', 'seo', 'advertising agency', 'social media'],
  'Photography Studio': ['photographer', 'photography studio', 'portrait photographer', 'wedding photographer'],
  'Tax Preparer': ['tax preparer', 'tax service', 'h&r block', 'tax filing', 'tax help'],
  'Financial Advisor': ['financial advisor', 'financial planner', 'wealth management', 'investment advisor'],
  
  // Healthcare
  'Dental Office': ['dentist', 'dentist near me', 'dental office', 'teeth cleaning', 'best dentist'],
  'Chiropractor': ['chiropractor', 'chiro near me', 'back pain', 'adjustment', 'best chiropractor'],
  'Optometrist': ['eye doctor', 'optometrist', 'eye exam', 'glasses', 'contacts'],
  'Veterinarian': ['vet', 'veterinarian', 'animal hospital', 'pet clinic', 'vet near me'],
  'Physical Therapy': ['physical therapy', 'pt near me', 'rehab', 'sports therapy', 'best pt'],
  'Urgent Care': ['urgent care', 'walk in clinic', 'urgent care near me', 'immediate care', 'er alternative'],
  'Pharmacy': ['pharmacy', 'drugstore', 'cvs', 'walgreens', 'prescription'],
  'Medical Clinic': ['doctor', 'clinic near me', 'primary care', 'family doctor', 'medical clinic'],
  'Mental Health': ['therapist', 'counseling', 'mental health', 'psychologist', 'therapy near me'],
  'Dermatologist': ['dermatologist', 'skin doctor', 'derm near me', 'acne treatment', 'skin care'],
  
  // Home Services
  'Plumber': ['plumber', 'plumber near me', 'plumbing', 'emergency plumber', 'best plumber'],
  'Electrician': ['electrician', 'electrician near me', 'electrical repair', 'best electrician'],
  'HVAC': ['hvac', 'ac repair', 'heating', 'hvac near me', 'air conditioning'],
  'Landscaping': ['landscaping', 'landscaper', 'lawn care', 'yard work', 'best landscaper'],
  'Cleaning Service': ['cleaning service', 'house cleaning', 'maid service', 'cleaners near me'],
  'Pest Control': ['pest control', 'exterminator', 'bug spray', 'termite', 'pest near me'],
  'Roofing': ['roofing', 'roofer', 'roof repair', 'roofer near me', 'best roofer'],
  'Painting': ['painter', 'house painting', 'painter near me', 'interior painting', 'best painter'],
  'Handyman': ['handyman', 'handyman near me', 'home repair', 'fix it', 'odd jobs'],
  
  // Entertainment & Events
  'Movie Theater': ['movie theater', 'cinema', 'movies near me', 'showtimes', 'best theater'],
  'Arcade': ['arcade', 'arcade near me', 'game room', 'video games', 'family fun'],
  'Escape Room': ['escape room', 'escape room near me', 'best escape room', 'puzzle room'],
  'Comedy Club': ['comedy club', 'stand up', 'comedy show', 'comedy near me', 'live comedy'],
  'Event Venue': ['event venue', 'party venue', 'wedding venue', 'banquet hall', 'event space'],
  
  // Hospitality
  'Hotel': ['hotel', 'hotel near me', 'best hotel', 'lodging', 'accommodation'],
  'Bed & Breakfast': ['bed and breakfast', 'b&b', 'inn', 'boutique hotel', 'cozy stay'],
  
  // Education
  'Tutoring Center': ['tutoring', 'tutor', 'tutoring near me', 'math tutor', 'sat prep'],
  'Music School': ['music lessons', 'piano lessons', 'guitar lessons', 'music school', 'music teacher'],
  'Driving School': ['driving school', 'driving lessons', 'learn to drive', 'drivers ed'],
  'Language School': ['language school', 'spanish lessons', 'english classes', 'esl', 'language lessons'],
  'Daycare': ['daycare', 'childcare', 'daycare near me', 'preschool', 'best daycare'],
  'Preschool': ['preschool', 'pre-k', 'early learning', 'preschool near me', 'best preschool'],
  
  // Financial
  'Bank': ['bank', 'bank near me', 'checking account', 'savings', 'best bank'],
  'Credit Union': ['credit union', 'cu near me', 'best credit union', 'member bank'],
  
  // Other
  'Other': ['best', 'top rated', 'near me', 'recommended', 'local'],
};

// Get all keywords for a business type
export function getKeywordsForType(businessType: string): string[] {
  return keywordSuggestions[businessType] || keywordSuggestions['Other'] || ['best', 'top rated', 'recommended'];
}

// Get a random subset of keywords for a business type (store attributes)
export function getRandomKeywords(businessType: string, count: number = 2): string[] {
  const keywords = getKeywordsForType(businessType);
  const shuffled = [...keywords].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, count);
}

// Get random demo keywords for a business type (search-focused)
export function getRandomDemoKeywords(businessType: string, count: number = 2): string[] {
  const keywords = demoKeywordSuggestions[businessType] || demoKeywordSuggestions['Other'] || ['best', 'top rated', 'near me'];
  const shuffled = [...keywords].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, count);
}
